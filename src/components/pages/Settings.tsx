...
const CARDS: SettingCard[] = [
  ...
  },
  {
    key: "email",
    title: "Email",
    description: "Transactional & outreach emails",
    Icon: IconMail,
    iconBg: "rgba(77,171,247,0.1)",
    iconColor: "#4dabf7",
    togglable: true,
    fields: [
      { label: "Provider", key: "emailProvider", placeholder: "", options: ["Resend", "SendGrid", "Mailgun"] },
      { label: "API Key", key: "emailApiKey", type: "password", placeholder: "re_..." },
      { label: "From Address", key: "emailFrom", placeholder: "you@yourdomain.com", hint: "Sender shown to recipients" },
    ],
  },
  {
    key: "sms",
